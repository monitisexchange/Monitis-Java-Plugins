...
public class MonitisFilter extends Filter {
	...
	private String minAllowedLevel = "WARN";
	private Level _minAllowedLevel = Level.WARN;
	...
	public int decide(LoggingEvent event) {
		int ret = DENY;
		if (event.getLevel().isGreaterOrEqual(_minAllowedLevel)){
			if (cmp_pattern != null){
	...
	public String getMinAllowedLevel() {
		return minAllowedLevel;
	}

	public void setMinAllowedLevel(String minAllowedLevel) {
		this.minAllowedLevel = minAllowedLevel;
		this._minAllowedLevel = Level.toLevel(minAllowedLevel, Level.WARN);
	}
